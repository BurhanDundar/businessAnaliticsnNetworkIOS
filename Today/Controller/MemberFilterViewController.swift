...
class MemberFilterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.searchBtn.addTarget(self, action: #selector(getFilteredMembers), for: .touchUpInside)
    ...
    @objc private func getFilteredMembers(_ sender: Any){
        let appDelegate = UIApplication.shared.delegate as! AppDelegate
        let stringURL = "\(appDelegate.APIURL)/member/getFilteredMembers"
